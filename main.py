...
def fetch_run_activities(client, start_date):
    try:
...
def format_activity_data(client, activity):
    try:
...
def save_to_json(all_activity_data, earliest_date, latest_date):
...
def main():
    ...
    for activity in activities:
        ...
        activity_summary = format_activity_data(client, activity)
        if activity_summary:
